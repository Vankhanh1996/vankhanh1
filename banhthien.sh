...
makeConfig() {
	...
	echo "---------------"
	read -p "Link website: https://banhthien.xyz"
	echo "---------------"
	read -p "API key của web: admin@banhthien.xyz"
	echo "---------------"
...
Nodes:
  -
    PanelType: "V2board" 
    ApiConfig:
      ApiHost: "https://banhthien.xyz"
      ApiKey: "admin@banhthien.xyz"
      NodeID: $NodeID80
      NodeType: V2ray 
      Timeout: 30 
      EnableVless: false 
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/cert-cloudfly/banhthien.crt 
        KeyFile: /etc/XrayR/cert-cloudfly/banhthien.key
        Provider: cloudflare 
        Email: test@me.com
        DNSEnv: 
          CLOUDFLARE_EMAIL: 
