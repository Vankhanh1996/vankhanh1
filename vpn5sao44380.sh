...
makeConfig() {
	...
	echo "---------------"
	read -p "Link website: https://vpn5sao.com"
	echo "---------------"
	read -p "API key của web: admin@vpn5sao.com"
	echo "---------------"
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/cert-cloudfly/vpn5sao.crt 
        KeyFile: /etc/XrayR/cert-cloudfly/vpn5sao.key
        Provider: cloudflare 
        Email: test@me.com
        DNSEnv: 
          CLOUDFLARE_EMAIL: 
