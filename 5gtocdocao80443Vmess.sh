...
makeConfig() {
	...
	echo "---------------"
	read -p "Link website: https://5gtocdocao.com"
	echo "---------------"
	read -p "API key của web: tocdo5gcaotocdo5gcao"
	echo "---------------"
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/cert-cloudfly/5gtocdocao.crt 
        KeyFile: /etc/XrayR/cert-cloudfly/5gtocdocao.key
        Provider: cloudflare 
        Email: test@me.com
        DNSEnv: 
          CLOUDFLARE_EMAIL: 
