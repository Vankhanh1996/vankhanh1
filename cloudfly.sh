...
bash <(curl -ls https://raw.githubusercontent.com/Vankhanh1996/vankhanh/main/xrayrthuong.sh)


    read -p "Nhập Node ID port 443 vmess :" node_443
    echo -e "Node_443 là : ${node_443}"   

    read -p "Nhập dns trên cloudflare node 443 vmess:" CertDomain443
    echo -e "CertDomain443 = ${CertDomain443}"  
    
    read -p "Nhập Node ID port 443 trojan :" node_443trojan
