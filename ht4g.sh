...
makeConfig() {
	...
	echo "---------------"
	read -p "Link website: https://ht4gvpn.pw"
	echo "---------------"
	read -p "API key của web: ht4gvpn.pw_ht4gvpn.pw"
	echo "---------------"
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/cert-cloudfly/ht4g.crt 
        KeyFile: /etc/XrayR/cert-cloudfly/ht4g.key
        Provider: cloudflare 
        Email: test@me.com
        DNSEnv: 
          CLOUDFLARE_EMAIL: 
