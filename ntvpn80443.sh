...
makeConfig() {
	...
	echo "---------------"
	read -p "Link website: https://ntvpn.shop/"
	echo "---------------"
	read -p "API key của web: ntvpnhsbdjsns3jj4"
	echo "---------------"
...
Nodes:
  -
    PanelType: "V2board" 
    ApiConfig:
      ApiHost: "https://ntvpn.shop"
      ApiKey: "ntvpnhsbdjsns3jj4"
      NodeID: $NodeID80
      NodeType: V2ray 
      Timeout: 30 
      EnableVless: false 
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/cert-cloudfly/ntvpn.crt 
        KeyFile: /etc/XrayR/cert-cloudfly/ntvpn.key
        Provider: cloudflare 
        Email: test@me.com
        DNSEnv: 
          CLOUDFLARE_EMAIL: 
